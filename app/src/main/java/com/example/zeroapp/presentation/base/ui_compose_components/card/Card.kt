package com.example.zeroapp.presentation.base.ui_compose_components.card
...
fun CardWithIcons(
    ...
    ElevatedCard(
        ...
        Row(
            ...
            Spacer(modifier = Modifier.width(dimensionResource(id = com.example.zeroapp.R.dimen.spacer_height_2)))
            ...
            Spacer(modifier = Modifier.width(dimensionResource(id = com.example.zeroapp.R.dimen.spacer_height_5)))
